...
public class DivInstruction extends Instruction {
	...
	/**
	 * String representation of the values of the divInstruction object
	 * in the form "label opcode result source"
	 *
	 * @return the string representation of the div instruction
	 */
	@Override
	...
	public boolean equals(Object obj) {
		if (obj instanceof DivInstruction divInstruction) {
			return this.getClass().equals(divInstruction.getClass())
